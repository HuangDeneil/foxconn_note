...
token=`openstack token issue | grep "| id" | awk '{print $4}'`
curl -g -i -X GET http://127.0.0.1:9311/v1/secrets/f4006dde-78b5-45e4-9f9e-68260955576c/metadata -H "Accept: application/json" -H "X-Auth-Token: $token"
...
## 所有的secrets
curl -g -i -X GET http://127.0.0.1:9311/v1/secrets -H "Accept: application/json" -H "X-Auth-Token: $token"

curl -g -i -X GET http://127.0.0.1:9311/v1/secrets/de4b3aba-8229-4bc8-a1f9-b77bf9b75774 -H "Accept: application/json" -H "X-Auth-Token: $token"
...
curl -g -i \
-X POST http://127.0.0.1:9311/v1/secrets/ -H "Content-Type: application/json" \
-H "User-Agent: openstacksdk/0.101.0 keystoneauth1/5.0.0 python-requests/2.25.1 CPython/3.9.14" \
-H "X-Auth-Token: $token" \
-d '{"name": "test", 
"algorithm": "rsa", 
